...
<i class="fa fa-dashboard" ></i> painel de controle / Editar Perfil
...
<label class="col-md-3 control-label">nome de usuario: </label>
...
<label class="col-md-3 control-label">Email de usuario: </label>
...
<label class="col-md-3 control-label">Palavra-passe de usuario: </label>
...
<label class="col-md-3 control-label">trabalho de usuario: </label>
...
<label class="col-md-3 control-label">imagem de usuario: </label>
...
echo "<script>alert('Usuario foi alterado com sucesso e loga de novo')</script>";
