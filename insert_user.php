...
<i class="fa fa-dashboard" ></i> painel de controle / Inserir Usuario
...
<label class="col-md-3 control-label">Nome de suario: </label>
...
echo "<script>alert('1 usuario foi inserido com sucesso')</script>";
