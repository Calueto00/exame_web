...
<i class="fa fa-dashboard"> </i> painel de controle / Inserir Productos
...
<label class="col-md-3 control-label" > Producto Url </label>
...
Producto Url Example : navy-blue-t-shirt
...
<label class="col-md-3 control-label" > Selecionar uma fabricação </label>

<div class="col-md-6" >

<select class="form-control" name="manufacturer"><!-- select manufacturer Starts -->

<option> Selecionar uma fabricação </option>
...
<option> Selecionar uma categoria de produto </option>
...
<label class="col-md-3 control-label" > imagem de produto 1 </label>
...
<label class="col-md-3 control-label" > imagem de produto 2 </label>
...
<label class="col-md-3 control-label" > imagem de produto 3 </label>
...
<label class="col-md-3 control-label" > preço de venda de produto</label>
...
<label class="col-md-3 control-label" > tabelas de produto </label>
...
<a data-toggle="tab" href="#description"> descrição de produto </a>

</li>

<li>

<a data-toggle="tab" href="#features"> caracteristicas de produto </a>

</li>

<li>

<a data-toggle="tab" href="#video"> Sons e Videos </a>
...
<label class="col-md-3 control-label" > rotulo de produto </label>
...
echo "<script>alert('Producto foi inserido com sucesso')</script>";
