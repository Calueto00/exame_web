...
<i class="fa fa-dashboard" ></i> painel de controle / Editar inquerimento
...
<i class="fa fa-money fa-fw"></i> Editar tipo de inquerimento
...
<label class="col-md-3 control-label"> titulo do inquerimento </label>
