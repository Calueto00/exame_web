...
<i class="fa fa-dashboard"></i> painel de controle / Editar Termos
...
<label class="col-md-3 control-label">descrição de termos </label>
...
echo "<script>alert('1 caixa de termo foi alterada ')</script>";
