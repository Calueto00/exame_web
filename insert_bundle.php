...
<i class="fa fa-dashboard"> </i> painel de controle / Inserir pacote
...
pacote Url Example : navy-blue-t-shirt
...
echo "<script>alert('pacote foi inserido com sucesso')</script>";
