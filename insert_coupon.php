...
<i class="fa fa-dashboard"> </i> painel / Inserir Coupon
...
<i class="fa fa-money fa-fw"> </i> Inserir Coupon
...
<label class="col-md-3 control-label"> Coupon Titulo </label>
...
<label class="col-md-3 control-label"> Coupon Preço </label>
...
<label class="col-md-3 control-label"> Coupon Codigo </label>
...
<label class="col-md-3 control-label"> Coupon Limite </label>
...
<label class="col-md-3 control-label">Selecionar cupon para produto ou pacote</label>

<div class="col-md-6">

<select name="product_id" class="form-control">

<option> Selecionar cupon de produto  </option>
...
<option>Selecionar cupon para pacote</option>
...
echo "<script>alert('Novo cupon foi inserido')</script>";
