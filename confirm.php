...
<h1 align="center"> Porfavor confirme seu pagamento </h1>
...
<label>Selecionar mode de pagamento:</label>

<select name="payment_mode" class="form-control"><!-- select Starts -->

<option>Selecionar mode de pagamento</option>
<option>codigo de banco</option>
...
echo "<script>alert('seu pagamento foi recebido,ordenado será completado dentro de 24h')</script>";
