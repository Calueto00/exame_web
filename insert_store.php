...
<i class="fa fa-dashboard" ></i> panel de controle / Inserir armazenamento
...
<i class="fa fa-money fa-fw"></i> Inserir armazenamento
...
<label class="col-md-3 control-label"> titulo de armazenamento : </label>
...
<label class="col-md-3 control-label"> imagem de armazenamento : </label>
...
<label class="col-md-3 control-label"> descrição de armazenamento : </label>
...
<label class="col-md-3 control-label"> botão de armazenamento : </label>
...
<label class="col-md-3 control-label"> armazenamento Url : </label>
...
echo "<script>alert('Novo armazenamento foi inserido')</script>";
