...
<label class="col-md-3 control-label">mostrar o topo da categoria</label>
...
<label class="col-md-3 control-label">Selecioanr imagem da categoria</label>
...
echo "<script>alert('1 categoria foi alterada')</script>";
