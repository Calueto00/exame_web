...
<i class="fa fa-dashboard" ></i> painel de controle / Editar armazenamento
...
<i class="fa fa-money fa-fw"></i> Editar armazenamento
...
echo "<script>alert('1 coluna de armazenamento alterada com sucesso')</script>";
