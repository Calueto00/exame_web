  ...
  <main>
    ...
    <div class="nero">
      <div class="nero__heading">
        <span class="nero__bold">Producto </span>visualizar
      </div>
      <p class="nero__text">
      </p>
    </div>
...
<label class="col-md-5 control-label" >quantidade de pacote </label>

<div class="col-md-7" ><!-- col-md-7 Starts -->

<select name="product_qty" class="form-control" >

<option>Selecioanr quantidade</option>
<option>1</option>
<option>2</option>
<option>3</option>
<option>4</option>
...
<label class="col-md-5 control-label" >tamanho de pacote</label>

<div class="col-md-7" ><!-- col-md-7 Starts -->

<select name="product_size" class="form-control" >

<option>Selecioanr tamanho</option>
<option>Small</option>
<option>Medium</option>
<option>Large</option>
...
<i class="fa fa-heart" ></i> Adcioanr a lista de desejos
...
echo "<script>alert('você deve entrar para adicioanr para sua lista')</script>";
...
echo "<script>alert('este produto já foi adicioando a lista')</script>";
...
echo "<script> alert('Producto foi inserido na lista') </script>";
...
<h3 class="text-center">você também gosta desses produtos: nós oferecemos para você 3 top items. </h3>
