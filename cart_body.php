  ...
  <main>
    ...
    <div class="nero">
      <div class="nero__heading">
        <span class="nero__bold">carrinho de</span>loja
      </div>
      <p class="nero__text">
      </p>
    </div>
...
<p class="text-muted" > já tens <?php echo $count; ?> item(s) no seu carrinho. </p>
...
Proceguir checkout <i class="fa fa-chevron-right"></i>
...
echo "<script>alert('seu cupon foi aplicado')</script>";
...
echo "<script>alert('produto nãp existe no carrinho')</script>";
...
echo "<script> alert('seu cupon não é valido') </script>";
...
<h3 class="text-center"> você também gosta desses produtos</h3>
