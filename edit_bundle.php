...
<i class="fa fa-dashboard"> </i> painel de controle / Editar pacote
...
<label class="col-md-3 control-label" > titilo do pacote </label>
...
<label class="col-md-3 control-label" > pacote Url </label>
...
pacote Url Exemplo : navy-blue-t-shirt
...
<label class="col-md-3 control-label" >imagem de pacote 1 </label>
...
<label class="col-md-3 control-label" > imagem de pacote 2 </label>
...
<label class="col-md-3 control-label" > imagem de pacote 3 </label>
...
<label class="col-md-3 control-label" > venda por preço do pacote </label>
...
<label class="col-md-3 control-label" > palavra chave do pacote </label>
...
<label class="col-md-3 control-label" > tabelas de pacote </label>
...
<a data-toggle="tab" href="#features"> caracteristicas do pacote </a>
...
<label class="col-md-3 control-label" > rotulo do pacote</label>
