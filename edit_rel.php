...
<i class="fa fa-dashboard"></i> painel de controle / Editar Relaçao
...
<i  class="fa fa-money fa-fw"></i> Editar Relaçao
...
<label class="col-md-3 control-label"> Selecioanr pacote  </label>
...
echo "<script>alert('Relação alterada com sucesso')</script>";
