...
<i class="fa fa-dashboard"></i> painel de controle / Inserir fabricação
...
<i class="fa fa-money fa-fw"> </i> Inserir fabricação
...
<label class="col-md-3 control-label"> nomeda fabricação </label>
...
<label class="col-md-3 control-label"> mosrar topo da fabricação </label>
...
<label class="col-md-3 control-label"> selecioanr imagem de fabricação</label>
...
echo "<script>alert('Nova fabricação foi inserida')</script>";
