  ...
  <main>
    ...
    <div class="nero">
      <div class="nero__heading">
        <span class="nero__bold">My </span>Conta
      </div>
      <p class="nero__text">
      </p>
    </div>
...
<strong> Aviso! </strong> porfavor confirme seu email e se não recebeu sua confiração de email
...
echo "<script>alert('sua cofirmação de email foi enviado pra voce, check sua caixa de email')</script>";
