...
<i class="fa fa-dashboard"> </i> painel de controle / Editar Productos
...
<label class="col-md-3 control-label" > titulo d produto </label>
...
<label class="col-md-3 control-label" > preço do produto vendido </label>
...
<label class="col-md-3 control-label" > palavra chave do produto </label>
...
<a data-toggle="tab" href="#features"> caracteristicas do produto </a>
