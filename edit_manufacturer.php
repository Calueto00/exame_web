...
<i class="fa fa-dashboard"></i> painel de controle / Editar fabricação
...
<i class="fa fa-money fa-fw"> </i> Editar fabricação
...
<label class="col-md-3 control-label"> nome da fabricação </label>
...
<label class="col-md-3 control-label"> mostrar topo da fabricação </label>
...
<label class="col-md-3 control-label"> Selecionar imagem da fabricação </label>
